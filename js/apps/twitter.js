    ...
    async renderProfile(target) {
        ...
        header.innerHTML = `
            ...
            <div style="border-bottom:1px solid #eff3f4; display:flex; font-weight:bold;">
                <div style="flex:1; text-align:center; padding:15px; border-bottom:3px solid #1d9bf0;">Tweets</div>
                <div style="flex:1; text-align:center; padding:15px; color:#536471;">Replies</div>
                <div style="flex:1; text-align:center; padding:15px; color:#536471;">Likes</div>
            </div>
        `;
        ...
        const tweets = data.tweets.filter(t => 
            (target === 'me' && t.accountId === data.currentAccountId) || 
            (t.isAI && t.aiHandle === profileData.handle)
