...
`;
    ...
    renderContacts() {
        ...
        // Groups List (Hidden by default, toggle logic could be added)
    ...
    async renderMessages() {
        ...
        for(const m of msgs) {
            ...
            div.innerHTML = `
                ${m.senderId !== 'user' ? `<div class="msg-avatar" style="background-image:url('${avatar}')"></div>` : ''}
    ...
    addSystemMsg(text) {
        ...
        document.getElementById('chatMsgList').appendChild(div);
    }
